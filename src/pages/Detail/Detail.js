  ...
  return (
    ...
    >
      <CustomCard
        ...
        color="#0a2029" // default color is white
          ...
          <div className="col-span-5 col-start-3">
            <div className="grid grid-cols-3">
              ...
              <div className="col-span-2 ml-5" style={{ marginTop: "25%" }}>
                ...
                <p className="text-3xl leading-2 text-success-600 font-semibold">{filmDetail.tenPhim}</p>
                <p className="text-lg text-yellow-700 font-semibold">{filmDetail.moTa}</p>
              </div>
            </div>
          </div>
